...
>>>>>>> b8db9d60f00fcbc2024e9334583c4063a782ccab
  ...
  create_table "invited_members", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.bigint "order_id"
    t.bigint "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "order_informations", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.bigint "order_id"
    t.bigint "user_id"
    t.string "item_name"
    t.float "item_price"
